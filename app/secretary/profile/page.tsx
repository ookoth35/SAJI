...
export default function SecretaryProfilePage() {
  ...
  const [formData, setFormData] = useState({
    ...
    email: "jane.secretary@saji.com",
    phone: "+254700000001",
    jobTitle: "Financial Secretary",
    bio: "Managing transactions and payments for the marketplace platform.",
  })
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-4 md:p-8">
      <div className="max-w-4xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Secretary Profile</h1>
        ...
        <Card className="p-6 bg-white dark:bg-gray-800 border-0 rounded-xl shadow-sm mb-8">
          <div className="flex flex-col md:flex-row items-start md:items-center gap-6 mb-8 pb-8 border-b border-gray-200 dark:border-gray-700">
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Jane Secretary</h2>
              <p className="text-gray-600 dark:text-gray-400">jane.secretary@saji.com</p>
              <p className="text-sm text-gray-500 dark:text-gray-500 mt-1">Role: Financial Secretary</p>
            </div>
          </div>
          ...
          {activeTab === "notifications" && (
            <div className="space-y-6">
              <div>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Payment Notifications</h3>
                <div className="space-y-3">
                  <label className="flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-700 rounded-lg cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-600">
                    <input
                      ...
                      className="w-5 h-5"
                    />
                    <span className="text-gray-700 dark:text-gray-300">Email notifications for new payments</span>
                  </label>
                  <label className="flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-700 rounded-lg cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-600">
                    <input
                      type="checkbox"
                      ...
                      className="w-5 h-5"
                    />
                    <span className="text-gray-700 dark:text-gray-300">Push notifications for transaction updates</span>
                  </label>
                </div>
              </div>
              <Button className="bg-blue-600 hover:bg-blue-700 text-white font-semibold h-10 rounded-lg">
